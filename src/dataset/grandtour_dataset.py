"""
Adpated From https://github.com/prs-eth/Marigold/blob/main/src/dataset/vkitti_dataset.py
"""
...
class GrandTourDataset(BaseDepthDataset):
    def __init__(
        self,
        kitti_bm_crop=False,  # Crop to KITTI benchmark size
        valid_mask_crop=None,  # Evaluation mask. [None, garg or eigen]
        **kwargs,
    ) -> None:
        super().__init__(
            # GrandTour data parameter
            min_depth=1e-5,
            max_depth=60,  # 655.35
